...
if uploaded_file is not None:
    ...
    label = teachable_machine_classification(image, '/Users/alexandru-robertcroitoru/VSCode/MasterThesis/Master-Thesis---Image-Classifier/FinalModels/Shoes/keras_model.h5')
    if label == 0:
        st.write("Superstar")
    elif label == 1:
